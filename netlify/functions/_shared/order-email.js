...
<body style="font-family:monospace;background:#1A1916;padding:20px">
  <div style="max-width:600px;margin:0 auto;background:#252520;border:1px solid #3A3830;padding:32px">
    ...
    <table style="width:100%;border-collapse:collapse;font-size:13px;color:#A0988E">
      ...
      <tr><td style="padding:3px 0;color:#D4906A">NCC Margin (already included in base rate)</td><td style="color:#D4906A;text-align:right">$${order.ncc_fee_total.toLocaleString()}</td></tr>
      ...
      <tr><td style="padding:3px 0;color:#7AAAC0">— Community Impact (5% of NCC margin)</td><td style="color:#7AAAC0;text-align:right">$${order.community_impact_total.toLocaleString()}</td></tr>
    </table>
  </div>
</body>
</html>`;
